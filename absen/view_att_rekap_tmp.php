...
<div  class="page-header" align="center">
    ...
    <div style="text-align:left">
        <form action="rep_rekap_tmp.php" method="post" target="_blank">
...
<table class="table table-striped table-bordered table-fit">
    <thead>
        <tr>
            <th rowspan="2" width="<?php echo $defW; ?>"><strong>#</strong></th>
            <th rowspan="2" width="<?php echo $importantColW[0]; ?>"><strong>Nama</strong></th>
            ...
            <th width="<?php echo $defW*$dNum; ?>" colspan="<?php echo $dNum; ?>" style="text-align:center"><strong>KEHADIRAN</strong></th>
        </tr>
        <tr>
            <?php
                for($i=0;$i<$dNum;$i++){
