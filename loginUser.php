...
<p style="text-align: right">Non-Pegawai Dinas PUPR? <a href="?<?php echo (getGet("pg"))?"pg=".getGet("pg"):""; ?>">Gunakan Token</a></p>
<?php
...
<div style="text-align: center;border-top-style: solid; border-top-width: 1px; border-top-color: rgba(0,0,0,0.2);padding: 10px">
    Belum punya akun? <a href="login.php?signup=1<?php echo (getGet("pg"))?"&pg=".getGet("pg"):""; ?>">Daftar</a><br>
    <a href="login.php?forget=1<?php echo (getGet("pg"))?"&pg=".getGet("pg"):""; ?>">Lupa password?</a>
</div>